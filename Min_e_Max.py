...
max() -> Retorna o maior valor em um iterável ou o maior de dois ou mais elemnto.
...
#DESAFIO! Como encontrar a musica mais a tocada e a menos tocada e sem usar max(), min() e lambda?
