...
def menu() -> None:
    print('============================================================')
    print('================= B E M  -  V I N D O(A) ===================')
    print('==================== G E E K   S H O P =====================')
    print('============================================================')
        ...
        if produto:
            if len(carrinho) > 0:
                ...
                for item in carrinho:
                    quant: int = item.get(produto) # pega produto pela chave do dict com a função get
                    if quant:
...
def visualizar_carrinho() -> None:
    if len(carrinho) > 0:
        ...
        print('Ainda não exsitem produtos no carrinho!')
    sleep(2)
    menu()
