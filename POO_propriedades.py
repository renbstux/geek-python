...
Em linguagens de programação como o Java, ao declarmos atributos privados nas classes,
costumamos a criar métodos publicos para manipulação desses atributos. Esses metodos
são conhecidos por getters e setters, onde os getters retonam o valor do atributo
...
Melhores Praticas na criação de um programa:
